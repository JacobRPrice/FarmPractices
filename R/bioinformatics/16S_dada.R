...
ggsave(
  file.path(figs_path_16S,"dada_errF.png"),
...
ggsave(
  file.path(figs_path_16S,"dada_errR.png"),
  width = 7, height = 7, units = "in"
)
...
head(mergers[[1]])
saveRDS(mergers,file.path(rds_path_16S,"mergers.RDS"))
...
saveRDS(seqtab.all, file.path(rds_path_16S, "seqtab.all.RDS"))
...
saveRDS(seqtab, file.path(rds_path_16S, "seqtab.RDS"))
